...
function showImage(data){
	...
	if (imageHeight == false && imageWidth == false){
		...
		var imageFinal = '<div class="'+divClass+'-image imageOverlay" style="width:100%;height:100%;position:relative;"><img src="'+filepathNew+'?time='+divClass+'" position="'+imagePosition+'" style="max-width:100%; max-height:100%;width:'+ imageWidth +'px;"></div>';
	} else {
