...
const eventDefinitions = [
    ...
    {
        id: "SKILL_EFFECTS",
        name: "Skill - Effects Only",
        sources: [Source.CONSTELLATION],
        description: "When a user specifically uses an effect skill."
    },
    {
        id: "SKILL_STICKER",
    ...
    },
    {
        ...
        name: "Skill (Embers)",
        sources: [Source.CHAT],
        description: "When a user uses any Skill (Ie any Sticker, Effect, or Rally) that costs embers."
    },
    {
        id: "SKILL_STICKER_EMBERS",
        name: "Skill (Embers) - Sticker Only",
        sources: [Source.CHAT],
        description: "When a user specifically uses a Sticker that costs embers."
    },
    {
