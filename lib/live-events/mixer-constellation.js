...
function constellationConnect() {
    ...
    console.log('Connecting to Constellation.', channelId);
    ...
    ca.subscribe(prefix + 'update', data => {
        ...
        Update should not get passed to events router as users cant assign effects to it. This should be used for updating statistics in the app only.
        */
    ...
    ca.on('error', data => {
        ...
        reconnectService.reconnect('Constellation', 0, false, false);
    });
