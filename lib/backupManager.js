...
function startBackup(manualActivation = false){
    ...
    output.on('close', function() {
        ...
        if(manualActivation) renderWindow.webContents.send('info', "The backup has finished. You can close this message safely. (Backup size: "+ filesize +" bytes)");
    });
