   ...
   */
    onTriggerEvent: event => {
        return new Promise(async (resolve) => {
            ...
            case "list": {
                const cloudSyncCommands = require('../../../cloud-sync/commands/quotes-list');
                let binId = await cloudSyncCommands.getQuoteListSyncId(event.userCommand.commandSender);
                ...
                if (binId == null) {
                    ...
                    Chat.smartSend(
                        `Here a list of quotes! https://crowbartools.com/tools/firebot/quotes/?id=${binId}`,
                        event.userCommand.commandSender
                    );
                }
