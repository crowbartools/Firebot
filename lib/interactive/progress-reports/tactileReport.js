    ...
    while(i--) {
        ...
        if(tactile[i].pressFrequency === 0 && tactile[i].holding === null || tactile[i].pressFrequency === null && tactile[i].holding === 0){
            ...
            if(savedReport === undefined){
                ...
                if(fired === true && cooldown === true){
                    // This item is playing the fired animation and is on cooldown.
                    ...
                    // This item finished it's cooldown, but is currently disabled. Re-enable it.
                    ...
                    // This button is playing fired animation, but isn't on (or doesnt have) a cooldown.
            ...
            // If cooldown not zero, send a packet with disabled. Otherwise, send disabled false so it doesn't cooldown at all.
            if(cooldown !== 0){
