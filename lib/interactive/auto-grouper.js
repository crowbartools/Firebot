...
let chatApiPool = 1000; // This is the default rate limit set by mixer and will be updated as we go.
let chatApiReset = 0; // This is the time the rate limit will refresh. Will be updated as we go.
let groupWaitList = [];
