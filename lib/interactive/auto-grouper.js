...
const groupChangeQueue = require("./particpant-group-queue");
...
function groupParticipant(participant) {
    ...
    let eventMsg;
    if (targetGroup) {
        //queue participant for group change
        groupChangeQueue.queueParticipantForGroupChange(participant, targetGroup);
