...
function beamConnect(){
    ...
    beamClient.open({
        ...
        */
        ...
        .then(() => { return beamClient.ready(true); }); // Set client to ready.
...
function makeScene(sceneName){
    ...
    try{
        ...
        beamClient.createControls({"sceneID": sceneName, "controls": makeControls(sceneName)})
            .then(controls =>{
