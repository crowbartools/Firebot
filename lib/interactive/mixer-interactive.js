                ...
                for (scene of res.scenes){
                    ...
                    controls.forEach((control) => {
                        ...
                        control.on('mousedown', (inputEvent, participant) => {
                            ...
                            Controls.router('mousedown', mixerControls, mixerControl, controlJson, inputEvent, participant);
                        });
                        ...
                        control.on('mouseup', (inputEvent, participant) => {
                            ...
                            var mixerControls = controls;
                            var mixerControl = control;
                            Controls.router('mouseup', mixerControls, mixerControl, controlJson, inputEvent, participant);
                        });
...
function changeGroups(participant, groupid){
    console.log('Changing user to group: '+group+'.')
    ...
    if(group !== undefined){
        ...
        renderWindow.webContents.send('error', "A button tried to change someone to a group that does not exist. Make sure this group has a default scene selected in the board settings.");
    }
}
