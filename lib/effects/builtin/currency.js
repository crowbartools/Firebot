...
const currency = {
  ...
  optionsTemplate: `
    ...
    <div ng-if="effect.currency">
        ...
        <div class="effect-setting-container" ng-if="effect.action">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu currency-action-dropdown">
                    ...
                    <li ng-click="effect.target = 'All Online Users'">
                        <a href>All Online Users</a>
                    </li>
                    <li ng-repeat="userrole in mixerRoles track by $index" ng-click="effect.target = userrole">
                        <a href>{{userrole}}</a>
                    </li>
                </ul>
            </div>
        ...
        <div>
            <label class="control-fb control--checkbox" style="margin: 0px 15px 0px 0px"> Send a chat message?</tooltip>
