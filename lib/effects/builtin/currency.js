...
const currency = {
  ...
  optionsTemplate: `
    ...
    <div class="effect-specific-title"><h4>Currency</h4></div>
    <div class="btn-group">
    ...
    <div ng-if="effect.currency">
        <div class="effect-setting-container">
            <div class="effect-specific-title"><h4>Operation</h4></div>
            <div class="btn-group">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="effect-setting-container" ng-if="effect.action">
            ...
            <div class="effect-setting-container" ng-if="effect.target != null">
                <div class="effect-specific-title"><h4>Amount</h4></div>
        ...
        <div class="" ng-if="effect.target">
            <div class="effect-setting-container">
                <div class="effect-specific-title"><h4></h4></div>
                <label class="control-fb control--checkbox" style="margin: 0px 15px 0px 0px"> Send Chat Message</tooltip>
    ...
    return new Promise(async (resolve, reject) => {
      ...
      switch (event.effect.target) {
        case "individual":
          ...
          currencyDatabase.addCurrencyToUser(
            userTarget,
