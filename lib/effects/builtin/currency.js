...
const currency = {
  ...
  optionsTemplate: `
    ...
    <div ng-if="effect.currency">
        ...
        <div class="effect-setting-container" ng-if="effect.action">


            <div class="effect-setting-container">
                <div class="settings-restrict" style="padding-bottom:1em">
                    <div class="settings-title">
                        <h3>Who is the target?</h3>
                    </div>
                ...
                <div class="settings-permission" style="padding-bottom:1em">
                    ...
                    <div ng-if="effect.target === 'individual'" class="input-group">
                        ...
                        <input type="text" class="form-control" aria-describedby="basic-addon3" ng-model="effect.userTarget">        
                    </div>
                    <div ng-show="effect.target === 'individual'">
            ...
            <div class="effect-setting-container" ng-if="effect.target != null">
                <div class="effect-specific-title"><h4>How much currency do we want to {{effect.action.toLowerCase()}}?</h4></div>
        ...
        <div class="" ng-if="effect.target">
            <div class="effect-setting-container">
                <div class="effect-specific-title"><h4>Send a chat message about it?</h4></div>
                <label class="control-fb control--checkbox" style="margin: 0px 15px 0px 0px"> Yes</tooltip>
                    <input type="checkbox" ng-init="sendChat = (effect.sendChat != null && effect.sendChat !== '')" ng-model="sendChat" ng-click="effect.sendChat = !effect.sendChat">
                    <div class="control__indicator"></div>
                </label>
            </div>

            <div class="effect-setting-container" ng-show="effect.sendChat">
