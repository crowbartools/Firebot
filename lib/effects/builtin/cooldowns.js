...
const cooldown = {
   ...
   */
    optionsTemplate: `
    <eos-container header="Buttons To Cooldown">
    ...
    <eos-container>
        <div class="effect-info alert alert-info">
            If you want to cool down a lot of buttons at the same time, give the cooldown groups a try in the board settings (little gear next to board name)!
        </div>
    </eos-container>
    `,
    /**
   ...
   */
    optionsController: ($scope, effectHelperService, boardService) => {
