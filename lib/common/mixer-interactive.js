...
function updateParticipants(participants) {
    return mixerClient.updateParticipants({participants: participants});
}
...
function changeGroups(participantInfo, groupidInfo) {
    ...
    if (groupidInfo !== "None") {
        changeGroupInternal(participantInfo, groupidInfo);
    }
...
function startupModificationLoop(interactiveCache) {
    ...
    return new Promise((resolve) => {
        let controls = interactiveCache['firebot'] && interactiveCache['firebot'].controls;
