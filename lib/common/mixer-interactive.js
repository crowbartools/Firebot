        ...
        mixerClient.synchronizeGroups()
            .then(() => {
                ...
                if (group !== undefined) {
                    ...
                    renderWindow.webContents.send('error', `Could not move ${participant.username} to group ${groupid} + ". Failed to get group data from Mixer. If issue persists, reconnect to Interactive.`);
                }
            });
    }
}
