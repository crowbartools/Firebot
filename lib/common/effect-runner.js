...
function runEffects(runEffectsContext, callback) {
  ...
  var triggerType = runEffectsContext.type;
  ...
  var isApi = (runEffectsContext.type === EffectType.TriggerType.API)
  ...
  var EffectTypeList = EffectType.getEffectDictionary(triggerType);
