...
const effectDefinitions = [
  {
    ...
    dependancies: [Dependency.CHAT]
  },
  {
    id: "CELEBRATION",
    name: "Celebration",
    triggerableBy: [Trigger.INTERACTIVE, Trigger.COMMAND, Trigger.CUSTOM_SCRIPT, Trigger.API],
    dependancies: [Dependency.OVERLAY]
  },
  {
    id: "CHANGE_GROUP",
    name: "Change Group",
    triggerableBy: [Trigger.INTERACTIVE, Trigger.CUSTOM_SCRIPT, Trigger.API],
    dependancies: [Dependency.INTERACTIVE]
  },
  {
    id: "CHANGE_SCENE",
    name: "Change Scene",
  ...
  },
  {
    ...
    dependancies: [Dependency.INTERACTIVE, Dependency.CHAT]
  },
  {
  ...
  },
  {
    ...
    dependancies: [Dependency.CHAT, Dependency.INTERACTIVE]
  },
  {
    id: "SCENE_LIST",
    name: "Scene List",
