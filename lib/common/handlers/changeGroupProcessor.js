...
function changeGroup(effect, trigger) {
    ...
    // No matches, this isn't an active group.
        renderWindow.webContents.send(
            "error",
            "You tried to switch people to an inactive group: " +
        groupid +
        ". To make this group active please give it a default scene on this board. Otherwise, remove this group from any change group buttons."
        );
    }
}
