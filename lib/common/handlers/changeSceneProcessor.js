            ...
            if (group !== null && group !== undefined) {
                ...
                if (success !== undefined) {
                    ...
                    renderWindow.webContents.send(
                        "error",
                        "Your scene change button tried to switch the scene for an intactive group: " +
              group +
              ". Make sure this group has a default scene selected on this board. Otherwise, check the settings for this change scene button."
                    );
                }
            }
        }
