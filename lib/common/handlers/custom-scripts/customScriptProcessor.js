...
function scriptProcessor(scriptName, parameters, control, userCommand, participant, firebotJson, triggerType) {
        ...
        if (typeof customScript.run === 'function') {
            ...
            setTimeout(function() {
                ...
                if (isV2Script) {
                    ...
                    let runRequest = {
                        modules: modules,
                        buttonId: button.controlId, // only here for backwards compat
                        button: button != null ? {
                                ...
                                if (data) {
                                    ...
                                    if (responseObject.success === true) {
                                        ...
                                        effects.forEach(e => {
                                            ...
                                            if (type !== null && type !== undefined && type !== "" && EffectType[enumSearch] !== null && EffectType[enumSearch] !== undefined) {
