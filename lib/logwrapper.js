...
// These next two lines are piggybacking off of functionality from data-access.
// If we include data access in this file, we start getting into dependency errors.
// If the root path changes we need to make sure to adjust this here and in data-access as well.
...
const LOG_FOLDER = userDataPath + '/logs';

let settingsfile = new JsonDB(userDataPath + '/global-settings', true, true);
