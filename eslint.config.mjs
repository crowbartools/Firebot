...
// Helper to resolve paths for tsconfig
...
{
    files: ["tests/**/*.ts", "jest.config.ts"], // Target only test files
    extends: [
        eslint.configs.recommended,
        tseslint.configs.recommendedTypeChecked
    ], 
...
// disable type checking for js/mjs files
{
    files: ["**/*.js", "**/*.mjs"],
