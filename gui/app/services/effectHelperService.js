  ...
  angular
    ...
    .factory("effectHelperService", function($q, utilityService, logger) {
                      ...
                      if (currentParameters != null) {
                        ...
                        Object.keys(currentParameters).forEach(
                          currentParameterName => {
                            let currentParamInDefaults =
                              defaultParameters[currentParameterName];
                        ...
                        Object.keys(defaultParameters).forEach(
                          defaultParameterName => {
                            let currentParam =
                              currentParameters[defaultParameterName];
                            let defaultParam =
                              defaultParameters[defaultParameterName];
      ...
      service.getTemplateFilePathForEffectType = function(effectType) {
        ...
        return (
          "./templates/interactive/effect-options/" +
