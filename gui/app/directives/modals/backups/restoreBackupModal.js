            ...
            function beginRestore() {
                ...
                $q(async function(resolve) {
                    try {
                        ...
                        $ctrl.restoreHasError = true;
                        $ctrl.errorMessage = "An unknown error occured while attempting to restore the backup. Please reach out to us on Discord or Twitter.";
                    }
                    resolve();
                });
            }
            ...
            $ctrl.$onInit = function() {
                ...
                $timeout(() => {
                    if (!$ctrl.restoreComplete && !$ctrl.restoreHasError) {
                        $ctrl.restoreHasError = true;
                        $ctrl.errorMessage = "Restore is taking longer than normal. There may have been an error. You can close and try again or check your log files and contact us. We are happy to help!";
                    }
                }, 30 * 1000);
            };
        }
