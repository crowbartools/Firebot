        ...
        .component("editStreamInfoModal", {
            template: `
                ...
                <div class="modal-body">
                    ...
                    <div ng-hide="$ctrl.dataLoaded" style="height: 200px;display: flex;align-items: center;justify-content: center;">
                    ...
                    <form ng-show="$ctrl.dataLoaded" name="streamInfo">
                        ...
                        <div class="form-group">
                            ...
                            <ui-select ng-model="$ctrl.selectedGame" required input-id="game" theme="bootstrap" spinner-enabled="true" on-select="$ctrl.gameSelected($item)" style="margin-bottom:10px;">
                                ...
                                <ui-select-choices minimum-input-length="1" repeat="game in $ctrl.games | filter: $select.search" refresh="$ctrl.searchGames($select.search)" refresh-delay="400" style="position:relative;">
