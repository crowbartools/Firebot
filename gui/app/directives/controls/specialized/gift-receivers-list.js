            ...
            template: `
                <div>
                    <div ng-repeat="receiver in $ctrl.model track by $index" class="list-item selectable" ng-click="$ctrl.showAddOrEditGiftReceiverModal(receiver)">
                        <div uib-tooltip="Click to edit" class="ml-8" style="font-weight: 400;width: 100%;" aria-label="{{receiver.gifteeUsername + ' (Click to edit)'}}"><b>{{receiver.gifteeUsername}}</b>: {{receiver.giftSubMonths}}</div>
            ...
            controller: function(utilityService) {
                ...
                $ctrl.showAddOrEditGiftReceiverModal = (giftReceiver) => {
                    utilityService.showModal({
                        ...
                        closeCallback: newGiftReceiver => {
                            $ctrl.model.push(newGiftReceiver);
                        }
                    });
                };
