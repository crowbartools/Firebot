            ...
            template: `
                <div>
                    <div ng-repeat="channel in $ctrl.model track by $index" style="margin-bottom: 4px;">
                        <div style="display:flex;height: 45px; align-items: center; justify-content: space-between;padding: 0 15px;background-color:#24262A;border-radius: 4px;">
                            <div style="font-weight: 100;font-size: 16px;">{{channel.name}}</div>
                            <div style="display: flex;align-items: center;justify-content: center;">
                                <button class="filter-bar" ng-click="$ctrl.editChannel($index)" style="margin: 0; margin-right: 13px;background:#35383e;" aria-label="Add channel">Edit</button> 
