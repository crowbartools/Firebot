        ...
        .component("rolePercentages", {
            ...
            <div>
                <div ui-sortable="$ctrl.sortableOptions" ng-model="$ctrl.model.roles">
                    <div ng-repeat="role in $ctrl.model.roles track by role.roleId" style="display: flex;flex-direction: row;align-items: center;justify-content: space-between;background: #41444b;border-radius: 15px;padding: 0 10px;margin-bottom:5px;">
                        ...
                        <span style="margin-left: 10px;" ng-click="$ctrl.removeRole(role.roleId)">
                ...
                <div style="margin-top: 16px;margin-left: 12px;">
                    <a class="clickable" ng-click="$ctrl.openAddRoleModal()"> <i class="far fa-plus-circle"></i> Add Role</a>               
                </div>
            </div>
            `,
