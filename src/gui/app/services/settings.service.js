    ...
    angular
        ...
        .factory("settingsService", function (utilityService, logger, profileManager, dataAccess, backendCommunicator) {
            ...
            service.ignoreSubsequentSubEventsAfterCommunitySub = function () {
                const ignoreSubEvents = getDataFromFile(
                    "/settings/ignoreSubsequentSubEventsAfterCommunitySub",
                    false,
                    true
                );
            ...
            service.getShowSevenTvEmotes = function () {
                const value = getDataFromFile(
                    "/settings/chat/emotes/seventv",
                    false,
                    service.getShowThirdPartyEmotes()
                );
                return value != null ? value : service.getShowThirdPartyEmotes();
            };
            ...
            service.setWebServerPort = function (port) {
                ...
                const path = dataAccess.getPathInWorkingDir("/resources/overlay/js/port.js");
            ...
            service.getForceOverlayEffectsToContinueOnRefresh = function () {
                const forceOverlayEffectsToContinueOnRefresh = getDataFromFile(
                    "/settings/forceOverlayEffectsToContinueOnRefresh",
                    false,
                    true
                );
            ...
            service.backupBeforeUpdates = function () {
                const backupBeforeUpdates = getDataFromFile("/settings/backupBeforeUpdates", false, true);
            ...
            service.getAudioOutputDevice = function () {
                ...
                return device != null ? device : defaultVal;
            };
            ...
            service.getSidebarControlledServices = function () {
                ...
                return services != null ? services : ["chat"];
            };
