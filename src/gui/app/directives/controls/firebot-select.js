...
(function() {
    const firebotSelectComponent = {
        ...
        <div class="btn-group" uib-dropdown>
            <button id="single-button" aria-label="{{$ctrl.ariaLabel || $ctrl.getSelectedOption()}}" type="button" class="btn btn-default" uib-dropdown-toggle ng-disabled="$ctrl.isDisabled">
