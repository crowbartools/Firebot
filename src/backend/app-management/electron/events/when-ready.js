...
exports.whenReady = async () => {
    ...
    await WindowManager.createSplashScreen();
    ...
    // load twitch auth
    WindowManager.updateSplashScreenStatus("Loading Twitch login system...");
    require("../../../auth/auth-manager");
    const twitchAuth = require("../../../auth/twitch-auth");
    twitchAuth.registerTwitchAuthProviders();

    // load accounts
    WindowManager.updateSplashScreenStatus("Loading accounts...");
    ...
    WindowManager.updateSplashScreenStatus("Loading startup script data...");
    ...
    WindowManager.updateSplashScreenStatus("Starting chat moderation manager...");
    const { ChatModerationManager } = require("../../../chat/moderation/chat-moderation-manager");
    ChatModerationManager.load();

    WindowManager.updateSplashScreenStatus("Loading counters...");
    const { CounterManager } = require("../../../counters/counter-manager");
    CounterManager.loadItems();

    WindowManager.updateSplashScreenStatus("Loading games...");
    ...
    WindowManager.updateSplashScreenStatus("Loading custom variables...");
    ...
    WindowManager.updateSplashScreenStatus("Loading sort tags...");
    const { SortTagManager } = require("../../../sort-tags/sort-tag-manager");
    SortTagManager.loadSortTags();

    // get importer in memory
    WindowManager.updateSplashScreenStatus("Loading importers...");
    ...
    WindowManager.updateSplashScreenStatus("Loading hotkeys...");
    const { HotkeyManager } = require("../../../hotkeys/hotkey-manager");
    HotkeyManager.loadHotkeys();

    WindowManager.updateSplashScreenStatus("Starting currency timer...");
    const currencyManager = require("../../../currency/currency-manager");
    currencyManager.startTimer();

    // Connect to DBs.
    WindowManager.updateSplashScreenStatus("Loading viewers...");
    ...
    WindowManager.updateSplashScreenStatus("Loading stats...");
    ...
    WindowManager.updateSplashScreenStatus("Loading quotes...");
    ...
    WindowManager.updateSplashScreenStatus("Running daily backup...");
    const { BackupManager } = require("../../../backup-manager");
    await BackupManager.onceADayBackUpCheck();

    // start the REST api server
    WindowManager.updateSplashScreenStatus("Starting internal web server...");
    ...
    WindowManager.updateSplashScreenStatus("Loading channel rewards...");
    ...
    WindowManager.updateSplashScreenStatus("Starting stream info poll...");
    const streamInfoPoll = require("../../../streaming-platforms/twitch/stream-info-manager");
    streamInfoPoll.startStreamInfoPoll();

    WindowManager.updateSplashScreenStatus("Starting notification manager...");
    ...
    WindowManager.updateSplashScreenStatus("Here we go!");
