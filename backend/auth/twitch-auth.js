...
const STREAMER_ACCOUNT_PROVIDER = {
    ...
    scopes: 'channel:edit:commercial bits:read channel:read:hype_train channel:read:subscriptions user:read:broadcast channel:moderate chat:edit chat:read whispers:read whispers:edit user:edit:broadcast'
};
