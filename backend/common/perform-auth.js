...
module.exports.register = function register(details) {
    ...
    if (typeof details.authURI !== 'string' || details.authURI === '') {
    ...
    if (typeof details.clientId !== 'string' || details.clientId === '') {
    ...
    if (details.responseType !== 'code' && details.responseType !== 'token') {
...
/**@desc Called once the external browser has been redirected to the local auth endpoint
