...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    ...
    // Dark mode
    'dark:text-primary-text dark:*:data-[slot=icon]:fill-zinc-400',
    'dark:data-hover:bg-white/5 dark:data-hover:*:data-[slot=icon]:fill-white',
    'dark:data-active:bg-white/5 dark:data-active:*:data-[slot=icon]:fill-white',
    'dark:data-current:*:data-[slot=icon]:fill-yellow-300'
  )
    ...
    <span className={clsx(className, 'relative')}>
      {current && (
        <motion.span
          ...
          className="absolute inset-y-2 -left-4 w-0.5 rounded-full bg-primary-bg dark:bg-yellow-300"
        />
      )}
      {'href' in props ? (
