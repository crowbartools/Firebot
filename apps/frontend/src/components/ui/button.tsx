...
const styles = {
  ...
  colors: {
    ...
    blue: [
      'text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-blue-500)] [--btn-border:var(--color-blue-700)]/90',
      '[--btn-icon:var(--color-blue-300)] data-active:[--btn-icon:var(--color-blue-300)] data-hover:[--btn-icon:var(--color-blue-300)]',
    ],
    violet: [
